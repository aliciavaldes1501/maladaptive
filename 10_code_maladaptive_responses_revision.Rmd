...
AppS1B<-(logger_data_pairs%>%
  ...
  geom_text_repel(data=. %>% filter(corr<0),aes(label=pair))+
  ggtitle("B)")
AppS1<-grid.arrange(AppS1A,AppS1B,ncol=2,
                    left=textGrob("Correlation coefficient\nsoil-air temperature",just="center",
                      hjust=0.42,
...
ggsave(filename="output/figures/AppS4.tiff",plot=AppS4,
