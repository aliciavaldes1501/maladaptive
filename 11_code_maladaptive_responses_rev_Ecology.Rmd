...
AppS2_figS2_B<-grid.arrange(
  ...
  ncol=1,top=textGrob("April 1st – June 5th",hjust=0.3,
                      gp=gpar(fontsize=16,fontfamily="serif")))
AppS2_figS2<-grid.arrange(AppS2_figS2_A,AppS2_figS2_B,ncol=2,
                          bottom=textGrob("Mean soil temperature (ºC)",
                                          just="center",
                                          gp=gpar(fontsize=16,
                                                  fontfamily="serif")))
...
pred_fitness_17<-ggpredict(selection_2017,
                           terms = c("ffd_std[all]","temp[6.32:26.90]"))
pred_fitness_18<-ggpredict(selection_2018,
